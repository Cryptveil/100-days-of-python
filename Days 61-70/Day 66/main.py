...
def patch_new_price(cafe_id):
    ...
    if cafe:
        ...
        return jsonify(error={"Not Found": "Sorry a cafe with that id was not\
...
def delete_cafe(cafe_id):
    ...
    if api_key == "TopSecretAPIKey":
        ...
        return jsonify(error={"Forbidden": "Sorry, that's not allowed. Make\
                sure you have the correct api_key."}), 403
